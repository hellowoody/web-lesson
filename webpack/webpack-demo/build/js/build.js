...
/* harmony import */ var _assets_css_a_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/assets/css/a.css */ "./src/assets/css/a.css");
...
__webpack_require__.e(/*! import() | test */ "test").then(__webpack_require__.bind(__webpack_require__, /*! ./test.js */ "./src/test.js")).then(({fn})=>{
    fn()
}).catch((e)=>{
    console.log(e)
})
...
/******/ 			if (chunkId === "main") return "assets/css/build.css";
/******/ 			// return url for filenames based on template
/******/ 			return "assets/css/" + chunkId + ".build.css";
/******/ 		};
/******/ 	})();
/******/ 	
